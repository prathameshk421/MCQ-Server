# Generated by Django 3.1.3 on 2026-09-01 12:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), size=4)),
                ('code', models.TextField(blank=True, null=True)),
                ('image_url', models.URLField(blank=True, null=True)),
                ('correct_option', models.PositiveIntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('fk_event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.event')),
            ],
        ),
        migrations.CreateModel(
            name='User_Event',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('fk_user_event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.user_event')),
            ],
        ),
        migrations.CreateModel(
            name='User_Question',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('fk_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.question')),
                ('fk_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
